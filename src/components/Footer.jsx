...
export default function Footer() {
  return (
    <div className="relative flex md:flex-row bg-slate-800 text-white flex-col gap-y-5 py-5 place-content-evenly text-center md:text-3xl text-xl border-t-2 border-orange-400">
      <div className='h-full'>
        <span className='text-2xl md:text-3xl text-orange-400'>Contact</span>
        <div className="flex flex-col gap-y-2 pl-2 ml-7 text-start md:place-items-start place-items-center text-xl text-slate-100 ">
      ...
      <div className="h-full">
        ...
        <div className="flex flex-row pt-5 gap-x-3 md:place-content-start place-content-center text-slate-100">
