...
const Item = ({ info }) => {
  ...
  return (
    <div className='relative group overflow-hidden'>
      ...
      <span onClick={() => addToCart(info)} className='absolute border hover:border-blue-900 bg-green-400 hover:bg-green-300 bottom-4 right-5 p-2 select-none cursor-pointer'><FaCartPlus /></span>
    </div>
  );
}
